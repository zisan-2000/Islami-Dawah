export const moktobData_nazmul = {
  ...
  data: [
    ...
    { label: "মক্তবের মোট ছাত্র-ছাত্রীর সংখ্যা", value: 85, max: 110 },
...
export const DayeBisoyData_nazmul = {
  title: "দা’য়ী বিষয়",
  data: [{ label: "সহযোগি দায়ী তৈরি হয়েছে", value: 5, max: 10 }],
};
...
export const DawatiBisoyData_nazmul = {
  ...
  data: [
    ...
    { label: "মক্তবের মোট ছাত্র-ছাত্রীর সংখ্যা", value: 180, max: 200 },
    ...
    { label: "বয়স্ক কোরআন শিক্ষা মোট অংশগ্রহণ করেছে", value: 57, max: 100 },
  ],
};
...
export const AmoliChartData_nazmul = [
  { name: "Closed", value: 60, color: "#28a745" }, // Green
  { name: "Remaining", value: 40, color: "#dc3545" }, // Red
];

export const TalimDonutChartData1_nazmul = [
  { name: "Completed", value: 75, color: "#28a745" }, // Green
  { name: "Pending", value: 25, color: "#dc3545" }, // Red
];

export const TalimDonutChartData2_nazmul = [
  { name: "Started", value: 70, color: "#007bff" }, // Blue
  { name: "Not Started", value: 30, color: "#ffc107" }, // Yellow
];
